...
class OutOfStockOrders extends StatefulWidget {
  @override
  _OutOfStockOrdersState createState() => _OutOfStockOrdersState();
}

class _OutOfStockOrdersState extends State<OutOfStockOrders> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 50,
        title: Text("All Out-Store Orders",style: TextStyle(
          fontWeight: FontWeight.bold,
          color: Colors.black,
        ),),
      ),
      body:FutureBuilder(
        future:db.getAllOutStockOrders(),
